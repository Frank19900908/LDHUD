...
- (void)initData
{
    self.dataArray = [NSMutableArray arrayWithArray:@[@"一  OneController", @"二  TwoController", @"三  ThreeController", @"四  FourController", @"五  FiveController", @"六  SixController", @"七  SevenController"]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *array = @[@"OneController", @"TwoController", @"ThreeController", @"FourController", @"FiveController", @"SixController", @"SevenController"];
